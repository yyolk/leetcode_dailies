...
class Solution:
    ...
    between them. There are `x` flowers in the first lane between Alice and Bob, and `y`
    ...
    2. In each turn, a player must choose either one of the lane and pick one flower
    from that side.
