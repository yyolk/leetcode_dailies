...
class Solution:
    ...
    * On the contrary, `4` is not a 2-mirror number. The representation of `4` in base-2
    ...
    def k_mirror(self, k: int, n: int) -> int:
        # Pre-computed sums of the smallest k-mirror numbers for k from 2 to 9 and n from 1 to 30
        # Outer list index: k - 2 (since k starts from 2)
        # Inner list index: n - 1 (to get sum of first n k-mirror numbers)
        # Each sublist contains cumulative sums for a specific base k
        return (
            [
                [
                    1,
