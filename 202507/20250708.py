...
class Solution:
    ...
    def max_value(self, events: list[list[int]], max_events_allowed: int) -> int:
        ...
        for current_index in range(total_events):
            ...
            next_non_overlapping_indices[current_index] = bisect.bisect_right(
                event_start_days, current_event_end_day
            )
        ...
        for current_index in range(total_events - 1, -1, -1):
            ...
            previous_max_values[current_index] = max(
                previous_max_values[current_index + 1], events[current_index][2]
            )
        ...
        for current_event_count in range(2, max_events_allowed + 1):
            ...
            for current_index in range(total_events - 1, -1, -1):
                ...
                current_max_values[current_index] = max(
                    current_max_values[current_index + 1], value_if_attend
                )
