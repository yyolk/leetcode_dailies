...
class Solution:
    ...
    **Note:** *In this version*, it is **valid** for the relative ordering of the
    ...
    def max_free_time(
        ...
        free_time_gaps = [start_time[0]] + [start_time[i] - end_time[i-1] for i in range(1, number_of_meetings)] + [event_time - end_time[-1]]
        
        # Calculate the duration of each meeting
        meeting_durations = [end_time[i] - start_time[i] for i in range(number_of_meetings)]
        ...
        for current_gap in free_time_gaps:
            ...
            if current_gap > largest_gap_size:
                ...
                third_largest_gap_size, third_largest_gap_count = second_largest_gap_size, second_largest_gap_count
                # Shift the second largest to largest
                second_largest_gap_size, second_largest_gap_count = largest_gap_size, largest_gap_count
        ...
        for meeting_index in range(number_of_meetings):
            ...
            largest_gaps_involved = (gap_before_meeting == largest_gap_size) + (gap_after_meeting == largest_gap_size)
            ...
            if largest_gaps_involved < largest_gap_count:
                ...
                second_largest_gaps_involved = (gap_before_meeting == second_largest_gap_size) + (gap_after_meeting == second_largest_gap_size)
            ...
            merged_gap_size = gap_before_meeting + meeting_durations[meeting_index] + gap_after_meeting
            ...
            if maximum_other_gap >= meeting_durations[meeting_index]:
                ...
                free_time_for_this_reschedule = merged_gap_size if merged_gap_size > maximum_other_gap else maximum_other_gap
            else:
                # If no, the free time is the merged gap minus the meeting duration
                free_time_for_this_reschedule = merged_gap_size - meeting_durations[meeting_index]
