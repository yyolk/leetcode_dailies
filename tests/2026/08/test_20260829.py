def test_lexicographically_smallest_array_examples(solution):
    ...
    assert solution.lexicographicallySmallestArray([1, 7, 6, 18, 2, 1], 3) == [
        1,
        6,
        7,
        18,
    ...
    assert solution.lexicographicallySmallestArray([1, 7, 28, 19, 10], 3) == [
        1,
        7,
        28,
        19,
